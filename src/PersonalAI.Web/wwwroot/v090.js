(() => {
  ...
  function ensureTaskDialog() {
    ...
    introTitle.textContent = "Tác vụ trong Context Manager v0.9.5";
    ...
    note.textContent = "v0.9.5 giữ tối đa 50 tác vụ trong mỗi không gian trên máy, hỗ trợ phụ thuộc giữa tác vụ và giữa các bước. Phụ thuộc không làm tăng quyền tự động: mỗi bước vẫn phải được người dùng chủ động chạy và các thao tác có tác động vẫn cần xác nhận." ;
